...
<div class="msg-date msg-date_{theme}" transition:fly="{{ y: -10, duration: 500 }}">
	<div class="msg-date-number msg-date-number_{theme} {klDate}">{tDate}</div>
...
<div class="msg-div msg-div_{theme}" transition:fly="{{ y: -10, duration: 500 }}">
	{message.text}
</div>
